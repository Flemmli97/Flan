...
public class OctoEconomyImpl implements CurrencyHandler {
    ...
    public static final Identifier ID = Identifier.fromNamespaceAndPath(Flan.MODID, "octo_economy");

    private Identifier currency;
    ...
    private Identifier getCurrency() {
        ...
        if (this.currency == null || !this.currency.toString().equals(ConfigHandler.CONFIG.currencyType)) {
            this.currency = Identifier.tryParse(ConfigHandler.CONFIG.currencyType);
        }
