...
======================
- Improve performance
- Update default values for gunpowder tag check cause it changed
...
- Add ignoredEntityTypes config to always ignore certain entities.
...
- Update gunpowder: fixes buying/selling claimblocks not changing the balance
...
- Update to 1.17.1 (fixes various crashes)
...
- Fix some items checking for wrong position and thus are able to interact in claims
- Fix enderpearl phasing through blocks
- Fix claims not respecting new world heights
