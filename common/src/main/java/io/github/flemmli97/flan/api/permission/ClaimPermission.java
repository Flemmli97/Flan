...
public class ClaimPermission implements Comparable<ClaimPermission> {
    ...
    public static class Builder {
        ...
        public static final Codec<ClaimPermission.Builder> CODEC = RecordCodecBuilder.create((instance) ->
                instance.group(Codec.BOOL.optionalFieldOf("global_default_value").forGetter(d -> d.globalVal ? Optional.empty() : Optional.of(false)),
                ...
                ).apply(instance, (globalVal, explicit, order, requiredMod, item, val, global)
