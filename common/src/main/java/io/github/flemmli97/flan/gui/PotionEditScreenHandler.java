        ...
        for (int i = 0; i < 54; i++) {
            if (i == 0) {
                ...
                if (id < potions.size()) {
                    ...
                    Component comp = new TranslatableComponent(ConfigHandler.LANG_MANAGER.get("screenPotionText"), txt).setStyle(txt.getStyle().withItalic(false).applyFormat(ChatFormatting.DARK_BLUE));
