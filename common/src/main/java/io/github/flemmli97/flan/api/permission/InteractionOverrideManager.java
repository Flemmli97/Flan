...
public class InteractionOverrideManager extends SimpleJsonResourceReloadListener {
    ...
    public static final InteractionType<Block> BLOCK_LEFT_CLICK = new InteractionType<>(new ResourceLocation(Flan.MODID, "block_left_click"), () -> new InteractionHolder<>(BuiltInRegistries.BLOCK, BLOCK_CODEC));
    public static final InteractionType<Block> BLOCK_INTERACT = new InteractionType<>(new ResourceLocation(Flan.MODID, "block_interact"), () -> new InteractionHolder<>(BuiltInRegistries.BLOCK, BLOCK_CODEC));
    public static final InteractionType<Item> ITEM_USE = new InteractionType<>(new ResourceLocation(Flan.MODID, "item_use"), () -> new InteractionHolder<>(BuiltInRegistries.ITEM, ITEM_CODEC));
    public static final InteractionType<EntityType<?>> ENTITY_ATTACK = new InteractionType<>(new ResourceLocation(Flan.MODID, "entity_attack"), () -> new InteractionHolder<>(BuiltInRegistries.ENTITY_TYPE, ENTITY_CODEC));
    public static final InteractionType<EntityType<?>> ENTITY_INTERACT = new InteractionType<>(new ResourceLocation(Flan.MODID, "entity_interact"), () -> new InteractionHolder<>(BuiltInRegistries.ENTITY_TYPE, ENTITY_CODEC));
