...
public class InteractionOverrideManager extends SimpleJsonResourceReloadListener {
    ...
    public static final Codec<List<Pair<Either<TagKey<Block>, Block>, ResourceLocation>>> BLOCK_CODEC = tagOrEntryCodec(Registry.BLOCK).listOf();
    public static final Codec<List<Pair<Either<TagKey<Item>, Item>, ResourceLocation>>> ITEM_CODEC = tagOrEntryCodec(Registry.ITEM).listOf();
    public static final Codec<List<Pair<Either<TagKey<EntityType<?>>, EntityType<?>>, ResourceLocation>>> ENTITY_CODEC = tagOrEntryCodec(Registry.ENTITY_TYPE).listOf();

    public static final InteractionType<Block> BLOCK_LEFT_CLICK = new InteractionType<>(new ResourceLocation(Flan.MODID, "block_left_click"), () -> new InteractionHolder<>(Registry.BLOCK, BLOCK_CODEC));
    public static final InteractionType<Block> BLOCK_INTERACT = new InteractionType<>(new ResourceLocation(Flan.MODID, "block_interact"), () -> new InteractionHolder<>(Registry.BLOCK, BLOCK_CODEC));
    public static final InteractionType<Item> ITEM_USE = new InteractionType<>(new ResourceLocation(Flan.MODID, "item_use"), () -> new InteractionHolder<>(Registry.ITEM, ITEM_CODEC));
    public static final InteractionType<EntityType<?>> ENTITY_ATTACK = new InteractionType<>(new ResourceLocation(Flan.MODID, "entity_attack"), () -> new InteractionHolder<>(Registry.ENTITY_TYPE, ENTITY_CODEC));
    public static final InteractionType<EntityType<?>> ENTITY_INTERACT = new InteractionType<>(new ResourceLocation(Flan.MODID, "entity_interact"), () -> new InteractionHolder<>(Registry.ENTITY_TYPE, ENTITY_CODEC));
