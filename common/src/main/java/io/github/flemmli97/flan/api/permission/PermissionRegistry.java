...
public class PermissionRegistry {
    ...
    public static ClaimPermission INTERACTSIGN = register(new ClaimPermission("INTERACTSIGN", () -> new ItemStack(Items.BIRCH_SIGN), "Permission to edit signs (e.g. dyeing them)"));
