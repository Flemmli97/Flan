...
public class CurrencyRegistry {
    ...
    private static final Map<ResourceLocation, CurrencyHandler> HANDLERS = new HashMap<>();

    public static synchronized void add(ResourceLocation id, CurrencyHandler impl) {
     ...
     */
    public static synchronized void add(ResourceLocation id, int order, CurrencyHandler impl) {
    ...
    private record OrderedResource(int order, ResourceLocation res) implements Comparable<OrderedResource> {
