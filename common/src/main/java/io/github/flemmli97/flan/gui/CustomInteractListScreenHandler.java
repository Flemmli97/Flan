                ...
                switch (this.type) {
                    case ITEM -> {
                        if (s.startsWith("#"))
                            ...
                            this.claim.allowedItems.addAllowedItem(Either.left(Registry.ITEM.get(new ResourceLocation(s))));
                    }
                    case BLOCKBREAK -> {
                        if (s.startsWith("#"))
                            ...
                            this.claim.allowedBreakBlocks.addAllowedItem(Either.left(Registry.BLOCK.get(new ResourceLocation(s))));
                    }
                    case BLOCKUSE -> {
                        if (s.startsWith("#"))
                            ...
                            this.claim.allowedUseBlocks.addAllowedItem(Either.left(Registry.BLOCK.get(new ResourceLocation(s))));
                    }
                }
                player.closeContainer();
