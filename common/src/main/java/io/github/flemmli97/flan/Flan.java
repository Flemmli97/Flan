...
public class Flan {
    ...
    public static boolean permissionAPI, playerAbilityLib, ftbRanks, diceMCMoneySign, octoEconomy, diamondCurrency, ftbChunks, gomlServer, mineColonies, commonProtApi;
