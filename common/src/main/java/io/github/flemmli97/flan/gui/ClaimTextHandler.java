        ...
        for (int i = 0; i < 9; i++) {
            switch (i) {
                ...
                case 2:
                    ...
                    ServerScreenHelper.addLore(stack, ServerScreenHelper.coloredGuiText(ConfigHandler.langManager.get("screenDelete"), Formatting.DARK_RED));
                ...
                case 3:
                    ...
                    ServerScreenHelper.addLore(stack2, ServerScreenHelper.coloredGuiText(ConfigHandler.langManager.get("screenDelete"), Formatting.DARK_RED));
                ...
                case 4:
                    ...
                    ServerScreenHelper.addLore(stack3, ServerScreenHelper.coloredGuiText(ConfigHandler.langManager.get("screenDelete"), Formatting.DARK_RED));
                ...
                case 5:
                    ...
                    ServerScreenHelper.addLore(stack4, ServerScreenHelper.coloredGuiText(ConfigHandler.langManager.get("screenDelete"), Formatting.DARK_RED));
