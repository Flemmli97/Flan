        ...
        for (int i = 0; i < 9; i++) {
            switch (i) {
                ...
                case 2 -> {
                    ...
                    stack.setHoverName(ServerScreenHelper.coloredGuiText("flan.screenEnterText", ChatFormatting.GOLD));
                ...
                case 3 -> {
                    ...
                    stack2.setHoverName(ServerScreenHelper.coloredGuiText("flan.screenEnterSubText", ChatFormatting.GOLD));
                    List<Component> lore = new ArrayList<>();
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenTextJson", ChatFormatting.GOLD));
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenDelete", ChatFormatting.DARK_RED));
                ...
                case 4 -> {
                    ...
                    stack3.setHoverName(ServerScreenHelper.coloredGuiText("flan.screenLeaveText", ChatFormatting.GOLD));
                    List<Component> lore = new ArrayList<>();
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenTextJson", ChatFormatting.GOLD));
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenDelete", ChatFormatting.DARK_RED));
                ...
                case 5 -> {
                    ...
                    stack4.setHoverName(ServerScreenHelper.coloredGuiText("flan.screenLeaveSubText", ChatFormatting.GOLD));
                    List<Component> lore = new ArrayList<>();
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenTextJson", ChatFormatting.GOLD));
                    lore.add(ServerScreenHelper.coloredGuiText("flan.screenDelete", ChatFormatting.DARK_RED));
